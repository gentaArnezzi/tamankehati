...
async def get_flora(flora_id: int, db: AsyncSession = Depends(get_session), user: User = Depends(current_user)):
    ...
    response_data = {
        ...
        "uses": obj.uses,
        "flowering_time": obj.flowering_time,
        "distribution": obj.distribution,
        "propagation_method": obj.propagation_method,
        "reference": obj.reference,
        "local_id": obj.local_id,
        "image_url": obj.image_url,
        "gambar_utama": obj.gambar_utama,
        "leaf_image_url": obj.leaf_image_url,
        "stem_image_url": obj.stem_image_url,
        "flower_image_url": obj.flower_image_url,
        "fruit_image_url": obj.fruit_image_url,
