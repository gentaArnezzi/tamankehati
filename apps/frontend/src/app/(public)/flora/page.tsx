...
import { getFloraList, getPublicStats } from "../../../lib/api/public";
...
export default async function FloraPage({ searchParams }: FloraPageProps) {
  ...
  return (
    <main>
      <FloraHero
        stats={{
          totalSpecies: publicStats.total_flora,
          totalFamilies: publicStats.total_famili_flora,
          totalProvinces: publicStats.total_provinsi,
        }}
      />
