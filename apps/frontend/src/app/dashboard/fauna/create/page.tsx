...
import { ArrowLeft, ArrowRight, Save, Loader2, Sparkles, Check, FileText, Globe, Shield, Camera, Eye } from 'lucide-react';
      ...
      <div className="border-b border-gray-200 bg-white">
        <div className="max-w-4xl mx-auto px-6 py-6">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              <h1 className="text-xl font-medium text-gray-900">Tambah Data Fauna</h1>
          ...
          {currentStep === 1 && (
            <div className="space-y-8 animate-in fade-in duration-500">
              <div>
                ...
                <p className="text-sm text-gray-500">Identitas dan klasifikasi taksonomi fauna</p>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="ordo" className="text-sm font-medium text-gray-700">Ordo</Label>
                  <Input
                    id="ordo"
          ...
          {currentStep === 2 && (
            <div className="space-y-8 animate-in fade-in duration-500">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-lg font-medium text-gray-900 mb-1">Ekologi</h2>
                  <p className="text-sm text-gray-500">Habitat dan karakteristik fauna</p>
                </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="habitat_sumber_makanan" className="text-sm font-medium text-gray-700">Habitat & Sumber Makanan</Label>
                  <Textarea
          ...
          {currentStep === 3 && (
            <div className="space-y-8 animate-in fade-in duration-500">
              <div>
                ...
                <p className="text-sm text-gray-500">Status hama, IUCN, dan endemisitas</p>
              </div>

              <div className="space-y-6">
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <Label htmlFor="status_hama" className="text-sm font-medium text-gray-700">Status Hama</Label>
                    <Select
                      value={formData.status_hama}
                      onValueChange={(value) => handleChange('status_hama', value)}
                    >
                      <SelectTrigger id="status_hama" className="h-11 border-gray-300 focus:border-gray-900 focus:ring-0">
                  ...
                  {(formData.status_hama === 'Ya' || formData.status_hama === 'Potensial') && (
                    <div className="space-y-1.5">
                      <Label htmlFor="tingkat_hama" className="text-sm font-medium text-gray-700">Tingkat Hama</Label>
                      <Select
                        value={formData.tingkat_hama}
                        onValueChange={(value) => handleChange('tingkat_hama', value)}
                      >
                        <SelectTrigger id="tingkat_hama" className="h-11 border-gray-300 focus:border-gray-900 focus:ring-0">
          ...
          {currentStep === 4 && (
            <div className="space-y-8 animate-in fade-in duration-500">
              <div>
                ...
                <p className="text-sm text-gray-500">Upload gambar utama dan tambahan</p>
              </div>
                ...
                <div className="border border-gray-200 rounded-lg p-5">
                  ...
                  <div className="space-y-3 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-gray-900 font-medium">{formData.ordo || '-'}</span>
                    </div>
                  </div>
                </div>

                <div className="border border-gray-200 rounded-lg p-5">
                  <h3 className="text-sm font-medium text-gray-900 mb-4">Ekologi</h3>
                  <div className="space-y-3 text-sm">
                    <div>
                    ...
                    <div>
                      <span className="text-gray-500 block mb-1">Habitat & Sumber Makanan</span>
                      <p className="text-gray-900 line-clamp-3">{formData.habitat_sumber_makanan || '-'}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="border border-gray-200 rounded-lg p-5">
                  ...
                  <div className="space-y-3 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-gray-900 font-medium">{formData.status_hama || '-'}</span>
                    </div>
                  </div>
                </div>
