...
import { TreePine, Bird, MapPin, Users, AlertCircle, CheckCircle, TrendingUp, Activity, Package } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm hover:shadow-md transition-shadow">
            ...
            <CardContent>
              ...
              <p className="text-sm text-green-600 dark:text-green-400 mt-2">+12% bulan ini</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm hover:shadow-md transition-shadow">
            ...
            <CardContent>
              ...
              <p className="text-sm text-green-600 dark:text-green-400 mt-2">+45 minggu ini</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm hover:shadow-md transition-shadow">
            ...
            <CardContent>
              ...
              <p className="text-sm text-green-600 dark:text-green-400 mt-2">+32 minggu ini</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm hover:shadow-md transition-shadow">
            ...
            <CardContent>
              ...
              <p className="text-sm text-green-600 dark:text-green-400 mt-2">+3 bulan ini</p>
            </CardContent>
          </Card>
        </div>
          ...
          <div className="lg:col-span-2">
            <Card className="border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm">
              <CardHeader>
                ...
                <CardDescription>Perubahan dan pembaruan data terkini</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {[
                    { icon: TreePine, title: "Taman baru ditambahkan", desc: "Taman Kehati Jawa Barat", time: "2 menit lalu", color: "green" },
                    { icon: Users, title: "Pengguna baru terdaftar", desc: "regional@kehati.org bergabung", time: "5 menit lalu", color: "blue" },
                    { icon: Bird, title: "Data fauna diperbarui", desc: "Elang Jawa - status konservasi", time: "10 menit lalu", color: "purple" },
                    { icon: Activity, title: "Backup sistem", desc: "Backup otomatis selesai", time: "1 jam lalu", color: "orange" },
                    { icon: CheckCircle, title: "Persetujuan data", desc: "5 data flora disetujui", time: "2 jam lalu", color: "green" },
                  ].map((activity, i) => (
                ...
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-sm text-gray-600 dark:text-gray-400">Tingkat Kelengkapan Data</span>
                      <span className="text-sm font-medium text-gray-900 dark:text-gray-100">87%</span>
                    </div>
                    <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                      <div className="bg-brand-500 h-2 rounded-full" style={{ width: '87%' }}></div>
                    </div>
                  </div>
                  
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-sm text-gray-600 dark:text-gray-400">Persetujuan Tertunda</span>
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-sm text-gray-600 dark:text-gray-400">Kegiatan Bulan Ini</span>
            ...
            <Card className="border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm">
              ...
              <CardContent>
                <div className="space-y-3">
                  {['Jawa Barat', 'Kalimantan Timur', 'Sulawesi Selatan', 'Sumatera Utara'].map((region, i) => (
        ...
        <Card className="border-brand-200 bg-brand-50 dark:border-brand-800 dark:bg-brand-900/20">
          <CardHeader>
            ...
            <CardDescription className="text-brand-700 dark:text-brand-300">
              Ini adalah halaman demo untuk mendemonstrasikan collapsible sidebar yang baru. 
              Klik tombol di sidebar untuk collapse/expand menu. Dark mode juga tersedia!
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-brand-600 dark:text-brand-400">
              <strong>Fitur:</strong> Smooth animations, dark mode support, role-based menu items, 
              notification badges, dan fully responsive design.
            </p>
          </CardContent>
        </Card>
      </div>
