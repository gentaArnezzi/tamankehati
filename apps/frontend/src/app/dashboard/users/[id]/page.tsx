                    ...
                    <div className="bg-blue-50 p-4 rounded-lg border-l-4 border-blue-400">
                      ...
                      <p className="text-sm text-blue-800">
                        {user.role === "super_admin" &&
                          "Super Administrator - Memiliki akses penuh ke semua fitur sistem"}
                        {user.role === "regional_admin" &&
                          "Admin Regional - Mengelola taman dan aktivitas di wilayah tertentu"}
                      </p>
                    </div>
                  </div>
                </CardContent>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-semibold text-blue-600">
                        {stats?.total_activities || 0} kegiatan
                      </span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-gray-600">Pengumuman</span>
                      <span className="font-semibold text-purple-600">
                        {stats?.total_announcements || 0} pengumuman
                      </span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-gray-600">
