        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Data from {new Date(data.date_range.start).toLocaleDateString()}{" "}
              to {new Date(data.date_range.end).toLocaleDateString()}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  {data.analytics.biodiversity.summary.total_endemic} endemic
                  species
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">Parks in system</p>
              </CardContent>
            </Card>
                ...
                <ResponsiveContainer width="100%" height={300}>
                  <BarChart
                    data={[
                      {
                        name: "Total",
                        flora: data.analytics.biodiversity.flora.total,
                        fauna: data.analytics.biodiversity.fauna.total,
                      },
                      {
                        name: "Endemic",
                        flora: data.analytics.biodiversity.flora.endemic,
                        fauna: data.analytics.biodiversity.fauna.endemic,
                      },
                      {
                        name: "Approved",
                        flora: data.analytics.biodiversity.flora.approved,
                        fauna: data.analytics.biodiversity.fauna.approved,
                      },
                    ]}
                  >
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      <Progress
                        value={
                          data.analytics.biodiversity.flora.total > 0
                            ? (data.analytics.biodiversity.flora.endemic /
                                data.analytics.biodiversity.flora.total) *
                              100
                            : 0
                        }
                        className="w-24"
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      <Progress
                        value={
                          data.analytics.biodiversity.fauna.total > 0
                            ? (data.analytics.biodiversity.fauna.endemic /
                                data.analytics.biodiversity.fauna.total) *
                              100
                            : 0
                        }
                        className="w-24"
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-1 text-sm text-muted-foreground">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span>
                        {(
                          data.analytics.conservation.parks.avg_area_ha || 0
                        ).toFixed(2)}{" "}
                        ha
                      </span>
                    </div>
