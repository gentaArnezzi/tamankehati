...
import { ArrowLeft, ArrowRight, Save, Loader2, Sparkles, Check, FileText, BookOpen, Shield, Camera, Eye } from 'lucide-react';
...
export default function CreateFloraPage() {
  ...
  const generateAllAI = async () => {
    ...
    try {
      ...
      const [descriptionRes, morphologyRes, benefitsRes] = await Promise.all([
        fetch(`${process.env.NEXT_PUBLIC_API_URL || 'https://tamankehati-backend-pxnu.onrender.com'}/api/v1/ai/public/generate-flora-description', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify(aiData),
          signal: controller.signal
        }),
        fetch(`${process.env.NEXT_PUBLIC_API_URL || 'https://tamankehati-backend-pxnu.onrender.com'}/api/v1/ai/public/generate-flora-morphology', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify(aiData),
          signal: controller.signal
        }),
        fetch(`${process.env.NEXT_PUBLIC_API_URL || 'https://tamankehati-backend-pxnu.onrender.com'}/api/v1/ai/public/generate-flora-benefits', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify(aiData),
          signal: controller.signal
      ...
      // Parse all responses
      const [descriptionResult, morphologyResult, benefitsResult] = await Promise.all([
        descriptionRes.json(),
        morphologyRes.json(),
        benefitsRes.json()
      ]);
  ...
  const handleSubmit = async (e: React.FormEvent, submitStatus: 'draft' | 'in_review' = 'in_review') => {
    ...
    if (currentStep !== STEPS.length) {
      console.log('Submit blocked - not at review step. Current step:', currentStep);
      return;
    }
      ...
      <div className="border-b border-gray-200 bg-white">
        <div className="max-w-4xl mx-auto px-6 py-6">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              <h1 className="text-xl font-medium text-gray-900">Tambah Data Flora</h1>
              <p className="text-sm text-gray-500 mt-0.5">Langkah {currentStep} dari {STEPS.length}</p>
            </div>
          </div>
            ...
            <div className="relative flex justify-between">
              {STEPS.map((step, index) => (
                <div key={step.id} className="flex flex-col items-center">
                  ...
                  <span className={`mt-2 text-xs font-medium transition-colors ${currentStep === index + 1 ? 'text-gray-900' : 'text-gray-400'}`}>
                    {step.title}
                  </span>
                </div>
              ))}
      ...
      <div className="max-w-2xl mx-auto px-6 py-12">
        <form onSubmit={handleSubmit} onKeyDown={(e) => {
          ...
          <div className="space-y-8 animate-in fade-in duration-500">
            <div>
              <h2 className="text-lg font-medium text-gray-900 mb-1">Informasi Dasar</h2>
              <p className="text-sm text-gray-500">Informasi identitas dan taksonomi flora</p>
            </div>

            <div className="space-y-6">
              <div className="space-y-1.5">
                <Label htmlFor="nama_ilmiah" className="text-sm font-medium text-gray-700">
              ...
              <div className="space-y-1.5">
                <Label htmlFor="nama_umum" className="text-sm font-medium text-gray-700">Nama Umum</Label>
                <Input
                  id="nama_umum"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  <Label htmlFor="famili" className="text-sm font-medium text-gray-700">Famili</Label>
                  <Input
                    id="famili"
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="genus" className="text-sm font-medium text-gray-700">Genus</Label>
                  <Input
                    id="genus"
                    placeholder="Contoh: Rafflesia"
          ...
          <div className="space-y-8 animate-in fade-in duration-500">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-lg font-medium text-gray-900 mb-1">Deskripsi</h2>
                <p className="text-sm text-gray-500">Informasi detail tentang flora</p>
              </div>
            ...
            <div className="space-y-6">
              <div className="space-y-1.5">
                <Label htmlFor="deskripsi" className="text-sm font-medium text-gray-700">Deskripsi Umum</Label>
                <Textarea
                  id="deskripsi"
              ...
              <div className="space-y-1.5">
                <Label htmlFor="morfologi" className="text-sm font-medium text-gray-700">Morfologi</Label>
                <Textarea
                  id="morfologi"
              ...
              <div className="space-y-1.5">
                <Label htmlFor="manfaat" className="text-sm font-medium text-gray-700">Manfaat</Label>
                <Textarea
                  id="manfaat"
          ...
          <div className="space-y-8 animate-in fade-in duration-500">
            <div>
              <h2 className="text-lg font-medium text-gray-900 mb-1">Status Konservasi</h2>
              <p className="text-sm text-gray-500">Informasi status dan endemisitas</p>
            </div>

            <div className="space-y-6">
              <div className="space-y-1.5">
                <Label htmlFor="status_iucn" className="text-sm font-medium text-gray-700">Status IUCN</Label>
                <Select
                  value={formData.status_iucn}
                  onValueChange={(value) => handleChange('status_iucn', value)}
                >
                  <SelectTrigger id="status_iucn" className="h-11 border-gray-300 focus:border-gray-900 focus:ring-0">
              ...
              <div className="flex items-center justify-between py-4 px-4 border border-gray-200 rounded-lg hover:border-gray-300 transition-colors">
                <div>
                  <Label htmlFor="is_endemic" className="text-sm font-medium text-gray-900 cursor-pointer">
          ...
          <div className="space-y-8 animate-in fade-in duration-500">
            <div>
              <h2 className="text-lg font-medium text-gray-900 mb-1">Galeri Foto</h2>
              <p className="text-sm text-gray-500">Upload gambar utama dan gambar tambahan untuk flora</p>
            </div>

            <div className="space-y-8">
              <div className="space-y-3">
                <Label className="text-sm font-medium text-gray-700">Gambar Utama</Label>
                <FileUpload
              ...
              <div className="space-y-3">
                <Label className="text-sm font-medium text-gray-700">Gambar Tambahan (Opsional)</Label>
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs">
                  <span className="px-3 bg-white text-gray-400">atau gunakan URL</span>
                </div>
              </div>

              <div className="space-y-1.5">
                <Label htmlFor="gambar_utama" className="text-sm font-medium text-gray-700">URL Gambar Eksternal</Label>
                <Input
                  id="gambar_utama"
                  type="url"
          ...
          {currentStep === 5 && (
            <div className="space-y-8 animate-in fade-in duration-500">
              <div>
                <h2 className="text-lg font-medium text-gray-900 mb-1">Review Data</h2>
                <p className="text-sm text-gray-500">Periksa kembali data sebelum menyimpan</p>
              </div>
              ...
              <div className="space-y-6">
                <div className="border border-gray-200 rounded-lg p-5">
                  ...
                  <div className="space-y-3 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="text-gray-900 font-medium">{formData.nama_ilmiah || '-'}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-500">Nama Umum</span>
                      <span className="text-gray-900 font-medium">{formData.nama_umum || '-'}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-500">Famili</span>
                      <span className="text-gray-900 font-medium">{formData.famili || '-'}</span>
                    </div>
                    <div className="flex justify-between">
                ...
                <div className="border border-gray-200 rounded-lg p-5">
                  <h3 className="text-sm font-medium text-gray-900 mb-4">Deskripsi</h3>
                  <div className="space-y-3 text-sm">
                    <div>
                      <span className="text-gray-500 block mb-1">Deskripsi Umum</span>
                      <p className="text-gray-900 line-clamp-3">{formData.deskripsi || '-'}</p>
                    </div>
                    <div>
                      <span className="text-gray-500 block mb-1">Morfologi</span>
                      <p className="text-gray-900 line-clamp-3">{formData.morfologi || '-'}</p>
                    </div>
                    <div>
                ...
                <div className="border border-gray-200 rounded-lg p-5">
                  <h3 className="text-sm font-medium text-gray-900 mb-4">Status Konservasi</h3>
                  <div className="space-y-3 text-sm">
                    <div className="flex justify-between">
                      <span className="text-gray-500">Status IUCN</span>
                      <span className="text-gray-900 font-medium">{formData.status_iucn || '-'}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-500">Endemik</span>
                      <span className="text-gray-900 font-medium">{formData.is_endemic ? 'Ya' : 'Tidak'}</span>
                    </div>
                  </div>
                </div>
