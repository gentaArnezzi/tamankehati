...
export const mockFloraData: MockFlora[] = [
  {
    ...
    status_iucn: "LC",
    deskripsi:
      "Pohon jati yang terkenal dengan kayunya yang kuat dan tahan lama. Kayu jati sangat dihargai untuk furnitur dan konstruksi.",
  ...
  },
  {
    ...
    status_iucn: "VU",
    deskripsi:
      "Pohon mahoni dengan kayu berkualitas tinggi. Kayu mahoni digunakan untuk furnitur mewah dan instrumen musik.",
  ...
  },
  {
    ...
    status_iucn: "LC",
    deskripsi:
      "Pohon sengon yang cepat tumbuh dan sering digunakan untuk reboisasi. Kayunya digunakan untuk pulp dan kertas.",
  ...
  },
  {
    ...
    status_iucn: "EN",
    deskripsi:
      "Pohon meranti yang merupakan spesies endemik hutan tropis. Kayunya sangat berharga untuk konstruksi.",
  ...
  },
  {
    ...
    status_iucn: "VU",
    deskripsi:
      "Pohon meranti putih yang tumbuh di hutan tropis. Kayunya digunakan untuk konstruksi dan furnitur.",
    habitat: "Hutan tropis dataran rendah",
    wilayah: "Sumatra, Kalimantan, Sulawesi",
...
export const mockFaunaData: MockFauna[] = [
  {
    ...
    status_iucn: "CR",
    deskripsi:
      "Harimau endemik Sumatera yang terancam punah. Merupakan subspesies harimau terkecil di dunia.",
  ...
  },
  {
    ...
    status_iucn: "EN",
    deskripsi:
      "Gajah Asia yang hidup di hutan Sumatera. Populasinya terus menurun akibat hilangnya habitat.",
    habitat: "Hutan tropis, rawa gambut",
    wilayah: "Sumatra",
  ...
  },
  {
    ...
    status_iucn: "CR",
    deskripsi:
      "Orangutan endemik Sumatera yang terancam punah. Merupakan salah satu kera besar yang paling terancam.",
    habitat: "Hutan tropis dataran rendah",
    wilayah: "Sumatra",
  ...
  },
  {
    ...
    status_iucn: "CR",
    deskripsi:
      "Badak Jawa yang merupakan mamalia terlangka di dunia. Hanya tersisa di Taman Nasional Ujung Kulon.",
    habitat: "Hutan tropis dataran rendah",
    wilayah: "Jawa",
...
export const mockApi = {
  getFlora: async (params?: {
    ...
    if (params?.status_iucn) {
      filteredData = filteredData.filter(
        (item) => item.status_iucn === params.status_iucn,
      );
    }
