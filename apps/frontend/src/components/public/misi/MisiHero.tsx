          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-8 animate-fade-in delay-500">
              <div className="text-center">
                <div className="text-lg font-medium text-white mb-1">Konservasi Flora</div>
              </div>
              <div className="text-center">
                <div className="text-lg font-medium text-white mb-1">Konservasi Fauna</div>
              </div>
              <div className="text-center">
                <div className="text-lg font-medium text-white mb-1">Ekosistem Berkelanjutan</div>
              </div>
            </div>
