      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          {waysToContribute.map((way, index) => (
            <div
              key={index}
              className="text-center p-8 border border-gray-200 hover:border-gray-300 hover:shadow-lg transition-all duration-300 bg-white rounded-xl animate-fade-in"
        ...
        <div className="bg-white rounded-xl p-12 border border-gray-200">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">
              Ada pertanyaan atau ingin berkolaborasi? Tim kami siap membantu
              Anda.
            </p>
          </div>
