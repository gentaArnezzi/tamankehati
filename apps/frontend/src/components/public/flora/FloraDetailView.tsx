                    ...
                    <dl className="grid gap-4 sm:grid-cols-2">
                      {flora.sinonim && (
                        <div className="space-y-1">
                          ...
                          <dd className="text-base text-slate-800 italic">
                            {flora.sinonim}
                          </dd>
                        </div>
                      )}
                      ...
                      {flora.penyebaran && (
                        <div className="space-y-1 sm:col-span-2">
                          ...
                          <dd className="text-base text-slate-800 whitespace-pre-line">
                            {flora.penyebaran}
                          </dd>
                        </div>
                      )}
              ...
              <aside className="space-y-6">
                ...
                <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-slate-600">
                    Status IUCN menggambarkan tingkat keterancaman spesies.
                    Gunakan informasi ini untuk menentukan prioritas tindakan
                    konservasi serta kebutuhan monitoring populasi di lapangan.
                  </p>
                  <Link
