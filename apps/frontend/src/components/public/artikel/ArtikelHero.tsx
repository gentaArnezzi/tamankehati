...
export function ArtikelHero() {
  ...
  return (
    <section className="relative h-[70vh] min-h-[500px] overflow-hidden">
      ...
      >
        <Image
          src="/tamankehati_images/task_01k8anpr0re96tcyw9ytdq02z1_1761295009_img_0.webp"
          alt="Latar belakang artikel tentang keanekaragaman hayati Indonesia"
          fill
          ...
          <div className="max-w-4xl">
            ...
            <div className="flex flex-wrap gap-8 text-white/80">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium">Edukasi & Riset</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 bg-blue-400 rounded-full"></div>
                <span className="text-sm font-medium">Konservasi</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 bg-purple-400 rounded-full"></div>
                <span className="text-sm font-medium">Cerita Lapangan</span>
              </div>
            </div>
          </div>
        </div>
