  ...
  const functions = [
    {
      title: "Konservasi",
      description:
        "Melindungi dan melestarikan spesies tumbuhan dan satwa lokal yang terancam punah atau langka, serta menjaga keberlangsungan ekosistem pendukungnya seperti penyerbuk dan pemencar biji.",
      image:
    ...
    },
    {
      title: "Edukasi",
      description:
        "Menjadi tempat pembelajaran bagi masyarakat, terutama pelajar, untuk mengenal jenis-jenis tanaman lokal, manfaatnya, dan pentingnya menjaga keanekaragaman hayati.",
      image:
    ...
    },
    {
      title: "Rekreasi",
      description:
        "Menyediakan ruang hijau yang nyaman bagi masyarakat untuk bersantai, beraktivitas fisik, dan menikmati keindahan alam.",
      image:
    ...
    },
    {
      ...
      description:
        "Beberapa taman kehati memanfaatkan teknologi seperti barcode, sistem hologram, atau aplikasi virtual untuk memberikan informasi lengkap kepada pengunjung tentang koleksi flora dan fauna di dalamnya.",
      image:
  ...
  return (
    <div className="bg-white">
        ...
        <div className="container mx-auto max-w-6xl px-12">
          <div className="text-center">
            ...
            <p className="text-xl text-white font-semibold max-w-5xl mx-auto leading-relaxed">
              Taman Kehati Indonesia berperan kritis dalam melindungi dan
              melestarikan spesies tumbuhan dan satwa yang terancam punah,
              menjaga keberlangsungan ekosistem yang mendukung kehidupan di
              Indonesia.
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-6xl px-12">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 leading-relaxed max-w-4xl mx-auto font-light">
              Taman Kehati berfungsi sebagai pusat konservasi in-situ dan
              ex-situ serta menjadi sarana edukasi dan rekreasi bagi masyarakat
              untuk memperkenalkan keanekaragaman hayati Indonesia secara lebih
              dekat, termasuk penggunaan teknologi informasi untuk edukasi.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-40 bg-green-800">
        <div className="container mx-auto max-w-6xl px-12">
          <div className="text-center">
            <h2 className="text-4xl font-bold text-white mb-12">Pengelolaan</h2>
            ...
            <div className="max-w-4xl mx-auto">
              <p className="text-xl text-white font-semibold leading-relaxed mb-12">
                Taman Kehati dikelola oleh{" "}
                <span className="font-black">Kementerian Lingkungan Hidup</span>{" "}
                sebagai bagian dari upaya nasional untuk melestarikan
                keanekaragaman hayati Indonesia dan mendukung pembangunan
                berkelanjutan.
              </p>
              <div className="bg-white rounded-2xl p-12 shadow-2xl border-l-8 border-green-800">
                ...
                <p className="text-gray-700 font-medium leading-relaxed">
                  Bertanggung jawab dalam pengelolaan, pengawasan, dan
                  pengembangan Taman Kehati di seluruh Indonesia untuk
                  memastikan konservasi keanekaragaman hayati yang efektif dan
                  berkelanjutan.
                </p>
              </div>
            </div>
