      ...
      <section className="relative -mx-6 md:-mx-8 lg:-mx-12">
        <div className="relative h-[400px] w-full md:h-[500px] lg:h-[600px]">
          <ImageWithFallback
            ...
            title={fauna.nama_umum || fauna.nama_ilmiah}
            fill
            priority
                  ...
                  <BreadcrumbList className="text-white/80">
                    ...
                    <BreadcrumbItem>
                      <BreadcrumbPage className="max-w-[200px] sm:max-w-none truncate text-white">
                        {fauna.nama_umum || fauna.nama_ilmiah}
                      </BreadcrumbPage>
                    </BreadcrumbItem>
                  </BreadcrumbList>
                </Breadcrumb>
          ...
          <div className="absolute bottom-0 left-0 right-0">
            <div className="container mx-auto max-w-7xl px-6 md:px-8 lg:px-12 py-8 md:py-12">
              ...
              <h1 className="mt-4 text-3xl font-light text-white md:text-4xl lg:text-5xl">
                {fauna.nama_ilmiah}
              </h1>
              {fauna.nama_umum && (
              ...
              <aside className="space-y-6">
                  ...
                  <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
                    ...
                    <div className="mt-4 space-y-3 text-sm text-slate-700">
                      ...
                      {fauna.park_info.description && (
                        <div className="mt-3">
                          <dt className="font-medium text-slate-600 mb-2">
                            Deskripsi Taman
                          </dt>
                ...
                <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-slate-600">
                    Informasi status IUCN dan perlindungan nasional digunakan
                    untuk menyusun prioritas intervensi serta edukasi
                    masyarakat.
                  </p>
                  <Link
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-600">
                  ...
                  <span className="italic">{fauna.nama_ilmiah}</span>
                </p>
              </div>
              <Badge
                variant="outline"
          ...
          <section className="space-y-6 mt-12">
            <div>
              ...
              <p className="text-sm text-slate-600">
                Kumpulan satwa dengan habitat serupa untuk mendukung
                pembelajaran lintas spesies.
              </p>
            </div>
