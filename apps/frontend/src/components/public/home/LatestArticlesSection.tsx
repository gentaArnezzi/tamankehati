    ...
    <section className="bg-[var(--bg,#f8f7f5)] py-20">
      <div className="container mx-auto max-w-7xl px-4">
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            <h2 className="text-3xl font-semibold text-slate-900 md:text-4xl">Artikel Terbaru</h2>
            <p className="mt-2 text-base text-slate-600">
              Sorotan cerita konservasi, riset terbaru, dan praktik lapangan dari seluruh penjuru Indonesia.
            </p>
          </div>
          <Link
            href="/artikel"
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          {articles.map((article) => (
            ...
            >
              <div className="text-sm font-medium uppercase tracking-wide text-emerald-600">{article.kategori}</div>
              ...
              <p className="mt-4 line-clamp-3 text-base leading-relaxed text-slate-600">{article.excerpt}</p>
              <Link
