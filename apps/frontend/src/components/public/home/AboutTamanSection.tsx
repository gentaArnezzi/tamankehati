...
export function AboutTamanSection() {
  ...
  const features = [
    {
      quote: 'Taman Kehati adalah inisiatif konservasi di tingkat daerah yang fokus pada penyelamatan dan pemulihan spesies lokal. Mengoleksi, menumbuhkan, dan merawat tanaman serta satwa yang mewakili identitas ekoregion setempat.',
    ...
    {
      quote: 'Mendorong edukasi lingkungan dan riset yang bertanggung jawab. Program pembelajaran yang mengajarkan pentingnya menjaga keseimbangan ekosistem dan keanekaragaman hayati.',
    ...
    {
      quote: 'Masyarakat dapat terlibat melalui kegiatan penanaman, pengamatan biodiversitas, hingga program relawan. Wisata alam yang bertanggung jawab untuk meningkatkan kesadaran lingkungan.',
  ...
  return (
    <section ref={ref} className="pt-12 pb-32 bg-white overflow-hidden relative z-0">
