...
import {
  ThreeDPhotoCarousel,
  type CarouselItem,
} from "@/components/ui/3d-carousel";
  ...
  const collections: CarouselItem[] = [
    {
      ...
      region: "Sumatera",
      description:
        "Bunga terbesar di dunia yang endemik di hutan Sumatera dengan diameter mencapai 1 meter",
    },
    {
      imgUrl:
        "https://images.unsplash.com/photo-1551739440-5dd934d3a94a?w=600&h=600&fit=crop",
      ...
      region: "Sumatera",
      description:
        "Primata besar yang terancam punah di hutan Sumatera, dikenal dengan kecerdasan dan perilaku sosialnya",
    },
    {
      imgUrl:
      ...
      region: "Kalimantan",
      description:
        "Anggrek endemik Kalimantan dengan bunga berwarna hitam yang langka dan eksotis",
    },
    {
      imgUrl:
        "https://images.unsplash.com/photo-1534188753412-5de315c1f1c0?w=600&h=600&fit=crop",
      name: "Komodo",
      ...
      description:
        "Kadal terbesar di dunia yang hanya ditemukan di Indonesia, dapat tumbuh hingga 3 meter",
    },
    {
      imgUrl:
      ...
      region: "Sumatera",
      description:
        "Bunga dengan perbungaan tertinggi di dunia, dapat mencapai tinggi 3 meter",
    },
    {
      imgUrl:
      ...
      region: "Bali",
      description:
        "Burung endemik Bali yang menjadi simbol konservasi dengan bulu putih yang indah",
    },
    {
      imgUrl:
      ...
      region: "Sumatera",
      description:
        "Subspesies harimau terkecil yang hanya hidup di Pulau Sumatera",
    },
    {
      imgUrl:
      ...
      region: "Kalimantan",
      description:
        "Tumbuhan karnivora unik yang dapat menangkap serangga dengan kantongnya",
    },
    {
      imgUrl:
        "https://images.unsplash.com/photo-1503066211613-c17ebc9daef0?w=600&h=600&fit=crop",
      name: "Elang Jawa",
      ...
      region: "Jawa",
      description:
        "Burung nasional Indonesia yang menjadi simbol keberanian dan kekuatan",
    },
    {
      imgUrl:
      ...
      region: "Jawa",
      description:
        "Bunga abadi yang tumbuh di puncak gunung-gunung tinggi di Jawa",
    },
  ];
      ...
      <div className="container mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <p className="max-w-3xl mx-auto text-xl text-slate-600 leading-relaxed">
            Jelajahi kekayaan flora dan fauna Indonesia yang dilindungi di
            taman-taman konservasi di seluruh Nusantara. Setiap spesies memiliki
            cerita unik tentang evolusi dan adaptasi.
          </p>
          <p className="mt-4 text-sm text-slate-500">
            🖱️ Geser carousel untuk melihat lebih banyak • Klik kartu untuk
            detail lengkap
          </p>
        </div>
        ...
        >
          <div className="rounded-3xl p-12">
            ...
            <p className="text-slate-600 mb-8 max-w-3xl mx-auto text-lg leading-relaxed">
              Jelajahi ribuan spesies flora dan fauna yang telah
              didokumentasikan dalam database Taman Kehati. Setiap penemuan baru
              membuka wawasan tentang keanekaragaman hayati Indonesia.
            </p>
