  ...
  const features = [
    {
      ...
      description:
        "Melindungi spesies langka di luar habitat alami dengan teknologi terdepan",
      image: "/hero/forest.webp",
    },
    {
      title: "Laboratorium Hidup",
      description:
        "Pusat penelitian dan pengembangan untuk keanekaragaman hayati Indonesia",
      image: "/hero/forest.webp",
    },
    {
      title: "Edukasi Interaktif",
      description:
        "Program pembelajaran yang menginspirasi generasi muda untuk menjaga alam",
      image: "/hero/forest.webp",
    },
  ];
      ...
      <div className="container mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <p className="max-w-3xl mx-auto text-lg text-gray-600">
            Dalam era perubahan iklim dan hilangnya habitat, Taman Kehati
            menjadi benteng terakhir untuk melindungi kekayaan hayati Indonesia
            yang tak ternilai.
          </p>
        </div>
