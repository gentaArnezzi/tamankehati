      ...
      <div className="container mx-auto max-w-7xl px-6 relative">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Transparansi data untuk mendukung riset, edukasi, dan aksi
            konservasi yang berdampak
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {mainStats.map((stat, index) => (
            ...
            >
              ...
              <div
                className={`absolute inset-0 bg-gradient-to-br ${stat.gradient} opacity-0 group-hover:opacity-5 rounded-3xl transition-opacity`}
              />

              <div className="relative">
                {/* Icon */}
                <div
                  className={`inline-flex p-4 rounded-2xl bg-gradient-to-br ${stat.gradient} shadow-lg shadow-${stat.color}-500/50 mb-6`}
                >
          ...
          <div className="relative grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-white/90 leading-relaxed mb-8">
                Setiap hari, kami bekerja bersama komunitas peneliti, akademisi,
                dan pelestari untuk melindungi kekayaan hayati Indonesia bagi
                generasi mendatang.
              </p>
