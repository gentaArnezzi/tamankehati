  ...
  const stories: Story[] = [
    {
      ...
      description:
        "Program konservasi kolaboratif berhasil menyelamatkan habitat orangutan tapanuli dan meningkatkan populasi mereka melalui restorasi hutan dan pemberdayaan masyarakat.",
      stats: [
    ...
    },
    {
      ...
      description:
        "Inisiatif restorasi terumbu karang melibatkan komunitas lokal dan menghasilkan pemulihan ekosistem laut yang signifikan, meningkatkan biodiversitas dan mata pencaharian nelayan.",
      stats: [
    ...
    },
    {
      ...
      description:
        "Program monitoring dan edukasi masyarakat berhasil melindungi habitat Rafflesia arnoldii dan menemukan koloni baru, memastikan kelestarian bunga langka ini.",
      stats: [
      ...
      <div className="container mx-auto max-w-7xl px-6 relative">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Perubahan nyata dimulai dari aksi kecil. Lihat bagaimana upaya
            konservasi membawa dampak besar bagi lingkungan dan masyarakat
          </p>
        </motion.div>
        ...
        >
          {stories.map((story, index) => (
            ...
            >
              ...
              <h4
                className={`font-bold mb-2 ${selectedStory === index ? "text-white" : "text-gray-900"}`}
              >
                {story.title}
              </h4>
              <p
                className={`text-sm mb-2 ${selectedStory === index ? "text-white/80" : "text-gray-500"}`}
              >
                {story.location}
              </p>
              <div
                className={`text-sm font-semibold flex items-center gap-1 ${selectedStory === index ? "text-white" : "text-emerald-600"}`}
              >
