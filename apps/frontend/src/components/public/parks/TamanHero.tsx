...
export function TamanHero() {
  ...
  return (
    <section className="relative h-[70vh] min-h-[500px] overflow-hidden">
      ...
      >
        <Image
          src="/tamankehati_images/task_01k8ang46ge3ms9jtax5betz6d_1761294797_img_0.webp"
          alt="Taman Keanekaragaman Hayati Indonesia"
          fill
          ...
          <div className="max-w-4xl">
            ...
            <div className="flex flex-wrap gap-8 text-white/80">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium">8+ Taman Terdata</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 bg-blue-400 rounded-full"></div>
                <span className="text-sm font-medium">5+ Provinsi</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 bg-green-400 rounded-full"></div>
                <span className="text-sm font-medium">Konservasi Alam</span>
              </div>
            </div>
          </div>
        </div>
