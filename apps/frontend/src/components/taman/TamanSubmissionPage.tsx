...
export function TamanSubmissionPage() {
  ...
  const loadParks = async () => {
    try {
      ...
      response.items?.forEach((park) => {
        console.log(
          `  - Park "${park.name}" (ID: ${park.id}) - Status: ${park.status}`,
        );
      });
  ...
  const handleSubmit = async (submitStatus: "draft" | "in_review") => {
    ...
    try {
      ...
      const errorMessage =
        err.response?.data?.detail || err.message || "Gagal submit taman";
  ...
  const handleSubmitPark = async (parkId: number) => {
    try {
      ...
      const errorMessage =
        err instanceof Error ? err.message : "Gagal submit park";
      toast.error(errorMessage);
    }
  };
  ...
  console.log("🔍 Conditional rendering check:", {
    ...
    approvedPark: approvedPark
      ? `"${approvedPark.name}" (${approvedPark.status})`
      : "none",
    parkInReview: parkInReview
      ? `"${parkInReview.name}" (${parkInReview.status})`
      : "none",
      ...
      <div className="space-y-6">
        ...
        <Card className="border-blue-200 bg-blue-50/50">
          <CardHeader>
            ...
            <CardDescription>
              Form pembuatan taman tidak tersedia saat taman Anda sedang dalam
              review
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Submitted:{" "}
                    {parkInReview.created_at
                      ? new Date(parkInReview.created_at).toLocaleDateString(
                          "id-ID",
                          {
                            day: "numeric",
                            month: "long",
              ...
              <div className="bg-white p-4 rounded-lg border border-blue-200">
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Taman Anda sedang dalam proses review oleh Super Admin
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-blue-600 mt-0.5">•</span>
                    <span>
                      Anda tidak dapat membuat taman baru sampai proses review
                      selesai
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-blue-600 mt-0.5">•</span>
                    <span>
                      Jika taman <strong>disetujui</strong>, Anda dapat
                      mengelola data flora, fauna, dan kegiatan
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-blue-600 mt-0.5">•</span>
                    <span>
                      Jika taman <strong>ditolak</strong>, Anda dapat membuat
                      submission baru
                    </span>
                  </li>
                </ul>
                      ...
                      return (
                        <div key={step.id} className="flex items-center flex-1">
                          <div className="flex flex-col items-center flex-1">
                            ...
                            <span
                              className={`text-xs font-medium text-center ${isActive ? "text-blue-600" : "text-gray-500"}`}
                            >
                              {step.label}
                            </span>
                          </div>
                      ...
                      <div className="space-y-6">
                        <div className="text-center mb-8">
                          ...
                          <p className="text-gray-600 text-lg">
                            Informasi dasar tentang taman kehati
                          </p>
                        </div>
                            ...
                            <div className="space-y-6">
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-2 md:col-span-2">
                                  ...
                                  />
                                  <p className="text-sm text-muted-foreground">
                                    Nomor Surat Keputusan (SK) penetapan atau
                                    penunjukan
                                  </p>
                                </div>
                                ...
                                <div className="space-y-2 md:col-span-2">
                                  ...
                                  />
                                  <p className="text-sm text-muted-foreground">
                                    Nama lembaga atau instansi yang mengelola
                                    taman
                                  </p>
                                </div>
                                ...
                                <div className="space-y-2 md:col-span-2">
                                  ...
                                  />
                                  <p className="text-sm text-muted-foreground">
                                    Upload beberapa foto untuk galeri taman
                                    (maksimal 10 foto, masing-masing 5MB)
                                  </p>
                                </div>
                              </div>
                            </div>
                    ...
                    <div className="animate-in fade-in slide-in-from-right-5 duration-300">
                      ...
                      <div className="space-y-6" data-tour="section-lokasi">
                        <div className="text-center mb-8">
                          ...
                          <p className="text-gray-600 text-lg">
                            Lokasi administratif taman kehati
                          </p>
                        </div>
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-2">
                                  ...
                                  <Select
                                    ...
                                    disabled={
                                      !selectedProvinceId || loadingCities
                                    }
                                  >
                                ...
                                <div className="space-y-2">
                                  ...
                                  <Select
                                    ...
                                    disabled={
                                      !selectedCityId || loadingDistricts
                                    }
                                  >
                                ...
                                <div className="space-y-2">
                                  ...
                                  <Select
                                    ...
                                    disabled={
                                      !selectedDistrictId || loadingVillages
                                    }
                                  >
                        ...
                        <div className="flex justify-between mt-8">
                          ...
                          <Button
                            size="lg"
                            onClick={() => setCurrentTab("karakteristik")}
                            className="gap-2 px-8"
                          >
                      ...
                      <div className="space-y-6">
                        <div className="text-center">
                          ...
                          <p className="text-sm text-gray-600">
                            Pilih koordinat taman konservasi menggunakan peta
                            interaktif
                          </p>
                        </div>
                    ...
                    <div className="animate-in fade-in slide-in-from-right-5 duration-300">
                      ...
                      <div className="space-y-6">
                        <div className="text-center mb-8">
                          ...
                          <p className="text-gray-600 text-lg">
                            Deskripsi fisik dan ekologi kawasan
                          </p>
                        </div>
                            ...
                            <div className="space-y-6">
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-2">
                                  ...
                                  />
                                  <p className="text-sm text-muted-foreground">
                                    Luas wilayah taman dalam hektar
                                  </p>
                                </div>
                                ...
                                <div className="space-y-2">
                                  ...
                                  <Select
                                    ...
                                    onValueChange={(value) =>
                                      handleInputChange("tipe_ekoregion", value)
                                    }
                                  >
                                    ...
                                    <SelectContent className="max-h-[400px]">
                                      ...
                                      <SelectItem value="Savana">
                                        Savana
                                      </SelectItem>
                                      <SelectItem value="Karst">
                                        Karst
                                      </SelectItem>
                                      ...
                                      <SelectItem value="Danau Toba">
                                        Danau Toba
                                      </SelectItem>
                                      <SelectItem value="Danau Poso">
                                        Danau Poso
                                      </SelectItem>
                                  ...
                                  <p className="text-sm text-muted-foreground">
                                    Pilih kategori ekoregion sesuai
                                    karakteristik kawasan (darat, air tawar,
                                    atau laut)
                                  </p>
                                </div>
                                ...
                                <div className="space-y-2 md:col-span-2">
                                  ...
                                  />
                                  <p className="text-sm text-muted-foreground">
                                    Kondisi umum (misal: hutan dataran rendah,
                                    rawa, pantai, dll)
                                  </p>
                                </div>
                                ...
                                <div className="space-y-2 md:col-span-2">
                                  ...
                                  />
                                  <p className="text-sm text-muted-foreground">
                                    Nilai penting ekologi atau keanekaragaman
                                    hayati kawasan
                                  </p>
                                </div>
                              </div>
                        ...
                        <div className="flex justify-between mt-8">
                          ...
                          <Button
                            size="lg"
                            onClick={() => setCurrentTab("deskripsi")}
                            className="gap-2 px-8"
                          >
                    ...
                    <div className="animate-in fade-in slide-in-from-right-5 duration-300">
                      ...
                      <div className="space-y-6">
                        <div className="text-center mb-8">
                          ...
                          <p className="text-gray-600 text-lg">
                            Gambaran menyeluruh tentang taman
                          </p>
                        </div>
                    ...
                    <div className="animate-in fade-in slide-in-from-right-5 duration-300">
                      ...
                      <div className="space-y-6">
                        <div className="text-center mb-8">
                          ...
                          <p className="text-gray-600 text-lg">
                            Visi, misi, dan nilai-nilai pengelolaan taman
                          </p>
                        </div>
                          ...
                          <CardContent className="pt-8 pb-6">
                            <div className="space-y-6">
                              ...
                              <div className="space-y-2">
                                ...
                                />
                                <p className="text-sm text-muted-foreground">
                                  Riwayat singkat tentang bagaimana taman ini
                                  terbentuk
                                </p>
                              </div>
                              ...
                              <div className="space-y-2">
                                ...
                                />
                                <p className="text-sm text-muted-foreground">
                                  Visi atau cita-cita jangka panjang pengelolaan
                                  taman
                                </p>
                              </div>
                              ...
                              <div className="space-y-2">
                                ...
                                />
                                <p className="text-sm text-muted-foreground">
                                  Langkah-langkah atau program untuk mencapai
                                  visi
                                </p>
                              </div>
                              ...
                              <div className="space-y-2">
                                ...
                                />
                                <p className="text-sm text-muted-foreground">
                                  Nilai-nilai atau prinsip yang dipegang dalam
                                  pengelolaan taman
                                </p>
                              </div>
                            </div>
          ...
          <CardContent>
            {loading ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-muted-foreground">
                  Belum ada taman yang disubmit. Submit taman pertama Anda di
                  atas!
                </p>
              </div>
            ) : (
                  ...
                  <TableBody>
                    {parks.map((park) => (
                      <TableRow key={park.id}>
                        ...
                        <TableCell>{getStatusBadge(park.status)}</TableCell>
