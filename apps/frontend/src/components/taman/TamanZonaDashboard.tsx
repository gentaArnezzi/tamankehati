        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-orange-600">
              {Array.isArray(parks)
                ? parks.filter((p) => p.status === "published").length
                : 0}
            </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-gray-600">
                {Array.isArray(parks)
                  ? parks.filter((p) => p.status === "archived").length
                  : 0}
              </div>
      ...
      <div className="space-y-6">
        {selectedPark && park ? (
          ...
          <div className="space-y-6">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">
                    {park.area_ha ? `${park.area_ha} ha` : "N/A"}
                  </div>
                </CardContent>
              </Card>
              <Card>
            ...
            <ParkDetailStats park={park} zones={[]} />
          </div>
        ) : (
          // Park List View
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>
                  {loading
                    ? "Memuat..."
                    : `${parksInRegion.length} taman ditemukan`}
                </CardDescription>
              </div>
              <div className="flex items-center gap-2">
                <Input
