      ...
      <DialogContent className="w-[98vw] max-w-7xl max-h-[95vh] overflow-y-auto">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4 sm:space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
              ...
              <Card>
                <CardHeader className="pb-3">
                  <CardTitle className="text-base sm:text-lg break-words">Informasi Dasar</CardTitle>
                ...
                <CardContent className="space-y-3 sm:space-y-4">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-sm font-medium">Judul *</FormLabel>
                        <FormControl>
                          <Input 
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-sm font-medium">Ringkasan</FormLabel>
                        <FormControl>
                          <Textarea 
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-sm font-medium">Prioritas</FormLabel>
                        <Select 
                        ...
                        >
                          ...
                          <SelectContent>
                            {PRIORITY_OPTIONS.map((priority) => (
                              <SelectItem key={priority.value} value={priority.value.toString()} className="text-sm">
                                {priority.label}
                              </SelectItem>
                            ))}
                          </SelectContent>
              ...
              <Card>
                <CardHeader className="pb-3">
                  <CardTitle className="text-base sm:text-lg break-words">Pengaturan</CardTitle>
                  <CardDescription className="text-xs sm:text-sm break-words">
                ...
                <CardContent className="space-y-3 sm:space-y-4">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3 sm:p-4">
                        <div className="space-y-0.5 flex-1 pr-2">
                          <FormLabel className="text-sm font-medium">Pin ke Atas</FormLabel>
                          <FormDescription className="text-xs break-words">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-col">
                        <FormLabel className="text-sm font-medium">Tanggal Kedaluwarsa</FormLabel>
                        <Popover>
                            ...
                            <FormControl>
                              ...
                              >
                                {expiresAt ? (
                                  ...
                                  <span className="truncate">Pilih tanggal kedaluwarsa (opsional)</span>
                                )}
                        ...
                        <FormDescription className="text-xs">
                          Pengumuman akan otomatis diarsipkan setelah tanggal ini
                        </FormDescription>
                        <FormMessage className="text-xs" />
                      </FormItem>
                    )}
            ...
            <Card>
              <CardHeader className="pb-3">
                <CardTitle className="text-base sm:text-lg break-words">Konten</CardTitle>
                <CardDescription className="text-xs sm:text-sm break-words">
              ...
              <CardContent>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-sm font-medium">Konten *</FormLabel>
                      <FormControl>
                        <Textarea 
            ...
            <Card>
              <CardHeader className="pb-3">
                <CardTitle className="text-base sm:text-lg break-words">Media & Lampiran</CardTitle>
                <CardDescription className="text-xs sm:text-sm break-words">
              ...
              <CardContent className="space-y-3 sm:space-y-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-sm font-medium">Gambar Utama</FormLabel>
                      <FormControl>
                        <Input 
