        ...
        {announcements.length === 0 ? (
          <Card>
            <CardContent className="p-8 text-center">
              <p className="text-muted-foreground">Tidak ada pengumuman ditemukan</p>
            </CardContent>
          </Card>
        ) : (
              ...
              <CardContent className="p-6">
                <div className="flex items-start justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {announcement.user_reactions.length > 0 && (
                          <div className="flex items-center gap-1">
                            {announcement.user_reactions.map((reaction, index) => (
                              <span key={index} className="text-sm">
                                {REACTION_TYPES.find(r => r.type === reaction)?.icon || '👍'}
                              </span>
                            ))}
                          </div>
                        )}
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {userRole === 'regional_admin' && (
                      <div className="flex items-center gap-1">
                        {announcement.requires_acknowledgment && !announcement.user_has_acknowledged && (
                          <Button
                            variant="outline"
                            size="sm"
