...
export default function ComprehensiveAIGenerator() {
  ...
  // Flora/Fauna states
  const [floraFaunaType, setFloraFaunaType] = useState<'flora' | 'fauna'>('flora');
  ...
  const [csvExtraction, setCsvExtraction] = useState<CSVExtractionResponse | null>(null);
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          Sistem AI lengkap untuk otomatisasi konten keanekaragaman hayati Indonesia
        </p>
      </div>
        ...
        <TabsContent value="flora-fauna">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Buat deskripsi, morfologi, dan manfaat untuk flora/fauna Indonesia
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setFloraFaunaData(prev => ({ ...prev, local_name: e.target.value }))}
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setFloraFaunaData(prev => ({ ...prev, scientific_name: e.target.value }))}
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setFloraFaunaData(prev => ({ ...prev, family: e.target.value }))}
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setFloraFaunaData(prev => ({ ...prev, genus: e.target.value }))}
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) => setFloraFaunaData(prev => ({ ...prev, iucn_status: value }))}
                  >
                    <SelectTrigger>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="CR">CR - Critically Endangered</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    onChange={(e) => setFloraFaunaData(prev => ({ ...prev, is_endemic: e.target.checked }))}
                  />
              ...
              {/* Generated Content */}
              {(generatedFloraFauna.description || generatedFloraFauna.morphology || generatedFloraFauna.benefits) && (
                <div className="space-y-4">
                  ...
                  {generatedFloraFauna.morphology && (
                    <div>
                      <Label className="text-sm font-semibold">Morfologi:</Label>
                      <Textarea
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setArticleData(prev => ({ ...prev, park_name: e.target.value }))}
              ...
              {generatedArticle && (
                <div className="space-y-4">
                  <div>
                    ...
                    <Input value={generatedArticle.title} readOnly className="mt-1" />
                  </div>
                  <div>
                    <Label className="text-sm font-semibold">Ringkasan:</Label>
                    <Textarea value={generatedArticle.summary} readOnly className="mt-1" rows={3} />
                  </div>
                  <div>
                    <Label className="text-sm font-semibold">Konten:</Label>
                    <Textarea value={generatedArticle.content} readOnly className="mt-1" rows={10} />
                  </div>
                </div>
              )}
            </CardContent>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setNewsData(prev => ({ ...prev, event: e.target.value }))}
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setNewsData(prev => ({ ...prev, location: e.target.value }))}
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setNewsData(prev => ({ ...prev, park_name: e.target.value }))}
                    placeholder="Contoh: Taman Nasional Kerinci Seblat"
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setNewsData(prev => ({ ...prev, impact: e.target.value }))}
              ...
              {generatedNews && (
                <div className="space-y-4">
                  <div>
                    ...
                    <Input value={generatedNews.headline} readOnly className="mt-1" />
                  </div>
                  <div>
                    <Label className="text-sm font-semibold">Lead:</Label>
                    <Textarea value={generatedNews.lead} readOnly className="mt-1" rows={2} />
                  </div>
                  <div>
                    <Label className="text-sm font-semibold">Konten:</Label>
                    <Textarea value={generatedNews.content} readOnly className="mt-1" rows={8} />
                  </div>
                </div>
              )}
            </CardContent>
        ...
        <TabsContent value="csv">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Upload file CSV taman dan biarkan AI mengekstrak data flora, fauna, dan artikel
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              {parkLoading ? (
                <div className="flex items-center justify-center py-8">
                  ...
                  <span className="text-muted-foreground">Memuat informasi taman...</span>
                </div>
              ) : (
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="park_id" className="flex items-center gap-2">
                    ...
                    <Input
                      ...
                      readOnly
                      className={parkInfo.park_id ? "bg-blue-50 border-blue-200 text-blue-900 font-medium cursor-not-allowed" : "bg-red-50 border-red-200 text-red-900 font-medium cursor-not-allowed"}
                      placeholder={parkInfo.park_id ? "ID Taman" : "User belum memiliki Park ID"}
                    />
                  ...
                  <div>
                    <Label htmlFor="park_name" className="flex items-center gap-2">
                      <Lock className="h-4 w-4" />
                      Nama Taman (Terkunci)
                    </Label>
                    <Input
                      ...
                      readOnly
                      className={parkInfo.park_name ? "bg-blue-50 border-blue-200 text-blue-900 font-medium cursor-not-allowed" : "bg-red-50 border-red-200 text-red-900 font-medium cursor-not-allowed"}
                      placeholder={parkInfo.park_name ? "Nama Taman" : "User belum memiliki Park Name"}
                    />
                    <p className="text-xs text-muted-foreground mt-1">
              ...
              <div className="flex gap-2">
                ...
                >
                  ...
                  {!parkInfo.park_id ? 'User belum memiliki Park ID' : 'Upload & Extract Data'}
                </Button>
              </div>
              ...
              {!parkInfo.park_id && (
                <Alert className="mt-4">
                  ...
                  <AlertDescription>
                    User belum memiliki Park ID yang di-assign. Silakan hubungi administrator untuk mengassign park ke user Anda.
                  </AlertDescription>
                </Alert>
              )}
                  ...
                  {csvExtraction.success && (
                    <div className="grid grid-cols-3 gap-4">
                      <div className="text-center p-4 bg-green-50 rounded-lg">
                        <div className="text-2xl font-bold text-green-600">{csvExtraction.flora_data.length}</div>
                        <div className="text-sm text-green-800">Flora</div>
                      </div>
                      <div className="text-center p-4 bg-blue-50 rounded-lg">
                        <div className="text-2xl font-bold text-blue-600">{csvExtraction.fauna_data.length}</div>
                        <div className="text-sm text-blue-800">Fauna</div>
                      </div>
                      <div className="text-center p-4 bg-purple-50 rounded-lg">
                        <div className="text-2xl font-bold text-purple-600">{csvExtraction.articles_data.length}</div>
                ...
                <div className="space-y-4 mt-6">
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Review dan edit mapping kolom CSV sebelum melakukan import data
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="text-center p-4 bg-gray-50 rounded-lg">
                          <div className="text-2xl font-bold text-gray-600">{csvPreview.total_rows}</div>
                          <div className="text-sm text-gray-800">Total Rows</div>
                        </div>
                        <div className="text-center p-4 bg-gray-50 rounded-lg">
                          <div className="text-2xl font-bold text-gray-600">{csvPreview.columns.length}</div>
                          <div className="text-sm text-gray-800">Columns</div>
                        </div>
                        <div className="text-center p-4 bg-gray-50 rounded-lg">
                          <div className="text-2xl font-bold text-gray-600">{csvPreview.mapping?.mapping_strategy || 'intelligent'}</div>
                          <div className="text-sm text-gray-800">Strategy</div>
                        </div>
                      </div>

                      {/* Flora Mapping */}
                      {editableMapping?.flora && Object.keys(editableMapping.flora).length > 0 && (
                        <div className="space-y-2">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                            {Object.entries(editableMapping.flora).map(([field, csvCol]) => (
                              <div key={field} className="flex items-center gap-2 p-2 bg-green-50 rounded border">
                                <span className="font-medium text-green-800 w-32">{field}</span>
                      ...
                      {/* Fauna Mapping */}
                      {editableMapping?.fauna && Object.keys(editableMapping.fauna).length > 0 && (
                        <div className="space-y-2">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                            {Object.entries(editableMapping.fauna).map(([field, csvCol]) => (
                              <div key={field} className="flex items-center gap-2 p-2 bg-blue-50 rounded border">
                                <span className="font-medium text-blue-800 w-32">{field}</span>
                                <span className="text-gray-600">→</span>
                                <Select
                                  value={csvCol as string}
                                  onValueChange={(value) => {
                      ...
                      {/* Articles Mapping */}
                      {editableMapping?.articles && Object.keys(editableMapping.articles).length > 0 && (
                        <div className="space-y-2">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                            {Object.entries(editableMapping.articles).map(([field, csvCol]) => (
                              <div key={field} className="flex items-center gap-2 p-2 bg-purple-50 rounded border">
                                <span className="font-medium text-purple-800 w-32">{field}</span>
                                <span className="text-gray-600">→</span>
                                <Select
                                  value={csvCol as string}
                                  onValueChange={(value) => {
                                    setEditableMapping(prev => {
                                      ...
                                      return {
                                        ...prev,
                                        articles: { ...prev.articles, [field]: value }
                                      };
                                    });
                                  }}
                                >
                      ...
                      {csvPreview.sample_data && (
                        <div className="space-y-2">
                          <h4 className="font-semibold text-gray-700">Sample Data (First 5 rows)</h4>
                          <div className="overflow-x-auto">
                            <table className="min-w-full border border-gray-200 rounded-lg">
                              ...
                              <tbody className="divide-y divide-gray-200">
                                {Array.from({ length: Math.min(5, csvPreview.total_rows) }, (_, i) => (
                                  <tr key={i}>
                                    {csvPreview.columns.map((col: string) => (
                                      <td key={col} className="px-3 py-2 text-sm text-gray-900 border-b">
                      ...
                      <div className="flex gap-2 pt-4">
                        ...
                        <Button 
                          onClick={() => {
                            ...
                            toast.success('Mapping berhasil disimpan! Silakan klik Upload & Extract Data untuk melanjutkan.');
