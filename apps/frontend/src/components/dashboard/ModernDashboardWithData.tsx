...
const ModernDashboardWithData: React.FC<ModernDashboardWithDataProps> = ({ user }) => {
  ...
  const sampleData = {
    ...
    portfolios: [
      { name: 'Flora Species', value: data?.analytics?.biodiversity?.flora?.total || 0, change: 2.16, positive: true, color: 'bg-green-500' },
      { name: 'Fauna Species', value: data?.analytics?.biodiversity?.fauna?.total || 0, change: -2.16, positive: false, color: 'bg-yellow-500' },
      { name: 'Protected Areas', value: data?.analytics?.conservation?.parks?.total || 0, change: -2.16, positive: false, color: 'bg-blue-500' }
    ],
    dailyTasks: [
      { name: 'Species Approval', current: data?.analytics?.biodiversity?.summary?.total_approved || 0, total: data?.analytics?.biodiversity?.summary?.total_species || 100 },
      { name: 'Park Management', current: data?.analytics?.conservation?.parks?.total || 0, total: 50 },
      { name: 'Activities', current: data?.analytics?.activities?.total || 0, total: 100 }
    ],
    users: [
      { name: 'John Doe', username: '@john.user', status: 'Active', role: 'Super Admin' },
      { name: 'Jane Smith', username: '@jane.smith', status: 'Active', role: 'Regional Admin' },
      { name: 'Bob Johnson', username: '@bob.johnson', status: 'Inactive', role: 'Regional Admin' }
    ]
  };
  ...
  const donutData = [
    { name: 'Approved', value: data?.analytics?.biodiversity?.summary?.total_approved || 0, color: '#10b981' },
    { name: 'Pending', value: (data?.analytics?.biodiversity?.summary?.total_species || 0) - (data?.analytics?.biodiversity?.summary?.total_approved || 0), color: '#f59e0b' },
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex">
        ...
        <div className="w-80 bg-white border-r border-gray-200 p-6 space-y-6">
          ...
          <Card>
            <CardHeader className="pb-4">
              <CardTitle className="text-lg font-semibold">Biodiversity Performance</CardTitle>
            </CardHeader>
            <CardContent>
                ...
                <div className="relative w-32 h-32">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <div className="text-xs text-gray-600">{data?.analytics?.biodiversity?.summary?.total_species || 0}</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between p-2 bg-green-50 rounded-lg">
                  ...
                  <span className="text-sm font-semibold text-green-800">{data?.analytics?.biodiversity?.summary?.total_approved || 0}</span>
                </div>
                <div className="flex items-center justify-between p-2 bg-yellow-50 rounded-lg">
                  <span className="text-sm font-medium text-yellow-800">Pending</span>
                  <span className="text-sm font-semibold text-yellow-800">{(data?.analytics?.biodiversity?.summary?.total_species || 0) - (data?.analytics?.biodiversity?.summary?.total_approved || 0)}</span>
                </div>
        ...
        <div className="flex-1 p-6 space-y-6">
          ...
          <Card>
            <CardHeader className="pb-4">
              <div className="flex items-center justify-between">
                <CardTitle className="text-lg font-semibold">Biodiversity Analytics</CardTitle>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="p-4 bg-white border border-gray-200 rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-medium text-gray-600">Total Species</span>
                    <TrendingUp className="h-4 w-4 text-green-500" />
                  </div>
                  <div className="text-2xl font-bold">{data?.analytics?.biodiversity?.summary?.total_species || 0}</div>
                  <div className="text-xs text-green-600 font-medium">+18%</div>
                </div>
                
                <div className="p-4 bg-white border border-gray-200 rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-medium text-gray-600">Endemic Species</span>
                    <TrendingUp className="h-4 w-4 text-green-500" />
                  </div>
                  <div className="text-2xl font-bold">{data?.analytics?.biodiversity?.summary?.total_endemic || 0}</div>
                ...
                <div className="p-4 bg-white border border-gray-200 rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-medium text-gray-600">Protected Areas</span>
                    <TrendingUp className="h-4 w-4 text-green-500" />
                  </div>
                  <div className="text-2xl font-bold">{data?.analytics?.conservation?.parks?.total || 0}</div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <Card className="bg-gradient-to-br from-blue-500 to-blue-600 text-white">
              <CardContent className="p-4">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm font-medium opacity-90">Total Species</span>
            ...
            <Card className="bg-gradient-to-br from-green-500 to-green-600 text-white">
              <CardContent className="p-4">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm font-medium opacity-90">Endemic Species</span>
            ...
            <Card className="bg-gradient-to-br from-purple-500 to-purple-600 text-white">
              <CardContent className="p-4">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm font-medium opacity-90">Protected Areas</span>
            ...
            <Card className="bg-gradient-to-br from-orange-500 to-orange-600 text-white">
              <CardContent className="p-4">
                ...
                <div className="text-2xl font-bold">{data?.analytics?.activities?.total || 0}</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold mb-4">
                  {(data?.analytics?.conservation?.parks?.total_area_ha || 0).toLocaleString()} ha
                </div>
                <div className="h-32">
                  <ResponsiveContainer width="100%" height="100%">
        ...
        <div className="w-80 bg-white border-l border-gray-200 p-6 space-y-6">
          ...
          <Card>
            <CardHeader className="pb-4">
              <div className="flex items-center justify-between">
                <CardTitle className="text-lg font-semibold">Conservation Performance</CardTitle>
                <Button variant="ghost" size="sm" className="text-blue-600">
                  View All
                </Button>
              </div>
            ...
            <CardContent className="space-y-4">
              <div className="p-4 bg-green-50 rounded-lg">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm font-medium text-green-800">Total Species</span>
                  <TrendingUp className="h-4 w-4 text-green-600" />
                </div>
                <div className="text-xl font-bold text-green-900">{data?.analytics?.biodiversity?.summary?.total_species || 0}</div>
                <div className="text-sm text-green-700">+5.3%</div>
              </div>
              
              <div className="p-4 bg-blue-50 rounded-lg">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm font-medium text-blue-800">Protected Area</span>
                  <TrendingUp className="h-4 w-4 text-blue-600" />
                </div>
                <div className="text-xl font-bold text-blue-900">{(data?.analytics?.conservation?.parks?.total_area_ha || 0).toLocaleString()} ha</div>
                <div className="text-sm text-blue-700">0.58%</div>
              </div>
              
              <div className="p-4 bg-purple-50 rounded-lg">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm font-medium text-purple-800">Activities</span>
                  <TrendingUp className="h-4 w-4 text-purple-600" />
                </div>
                <div className="text-xl font-bold text-purple-900">{data?.analytics?.activities?.total || 0}</div>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-lg font-semibold">Biodiversity Portfolio</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
